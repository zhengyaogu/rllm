...
REWARD_PATH=Skywork/Skywork-Reward-V2-Qwen3-1.7B
#MODEL_PATH=Qwen/Qwen3-0.6B

export NCCL_IGNORE_DISABLED_P2P=1
export TENSORBOARD_DIR="/workspace/mnt/temp/rllm/examples/deepscaler/tensorboard_log/disc"
...
python3 /workspace/mnt/temp/rllm/examples/deepscaler/train_deepscaler.py \
    ...
    actor_rollout_ref.actor.optim.linear_lr_warmup=20 \
